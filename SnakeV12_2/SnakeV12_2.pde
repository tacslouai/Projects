...
String playerOneControls = "Player  1:  W - up  A - left  S - down  D - right \n";
String playerTwoControls = "Player  2:  I - up  J - left  K - down  L - right \n";
int w = 40;
int h = 40;
int bs = 20;
int dir = 2;
  ...
  if(gameStart == false)
{
    ...
    fill(0, 255, 0);
    text(playerOneControls, 400, 500);
    fill(0, 0, 255);
    text(playerTwoControls, 400, 560);
    if(keyPressed == true)
    {
      gameStart = true;
    }
